...
def compute_macro_only_return(
    ...
    *,
    ...
    """Canonical macro delta: gated → overlay on raw → shrink toward scenario anchor."""
    ...
    macro_with_overlay, overlay = merge_overlay_into_macro(
        raw_macro,
        macro_factors,
        as_of_day=as_of_day,
        ticker=ticker,
    )
    macro = shrink_macro_delta(macro_with_overlay, scenario_anchor)
    provenance = {
